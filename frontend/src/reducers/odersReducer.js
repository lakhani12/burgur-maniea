import { CREATE_ORDER, CREATE_ORDER_ERROR, CREATE_ORDER_REQUEST, ORDER_DETAIlS, ORDER_DETAILS_FAIL, ORDER_DETAILS_REQURST, PAYMENT_METHOD, ORDER_TYPE, SEARCH_SUCCESS, SHEARCH_REQ, SERACH_ERROR } from "../actions/types";

...
import { genrateToken, isAuth, isAdmin } from "../utlis.js";
...
userRouter.delete('/:id', isAuth, isAdmin, expressAsyncHandler(async (req, res) => {
    ...
    if (user) {
        if (user.email === 'admin@example.com') { // Prevent deleting a main admin if desired, though here just matching a dummy check
...
userRouter.put('/:id/admin', isAuth, isAdmin, expressAsyncHandler(async (req, res) => {
    const user = await User.findById(req.params.id);
    if (user) {
